...
public class MultipleDocumentValidator implements ConstraintValidator<ValidDocuments, List<MultipartFile>> {

    private static final int MAX_FILE_SIZE_BYTES = 10 * 1024 * 1024; // 10 MB
    private static final int MAX_NUMBER_OF_FILES = 5;

    @Override
    public void initialize(ValidDocuments constraintAnnotation) {
    }
    ...
    private boolean isValidImageExtension(String filename) {
        ...
        List<String> validExtensions = List.of("jpg", "jpeg", "png", "gif", "webp", "pdf");
