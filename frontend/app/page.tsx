...
export default function Home() {
  ...
  return (
    <div className="h-screen min-h-screen container bg-gray-900 text-white">
      <nav className="flex items-center w-full bg-white px-8">
      ...
      <main className="flex flex-col items-center justify-between  text-white mt-8">
